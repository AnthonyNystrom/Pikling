    ...
    public partial class PlikingServerMain : Form
    {
        ...
        private bool SendEmail(String sFolder)
        {
            ...
            try
            {
                ...
                {
                    case "pdf":
                        Program.MainForm.AddLog("Preparing file PDF...");
                        sFilePdf = sFolder + "\\Pikling.pdf";
                        if (!doccre.CreatePdfFile(sDataSource, sDataDest, sFilePdf))
                        {
                            sFilePdf = "";
                            Program.MainForm.AddLog("Pdf Creator failed");
                        }
                        else
                            Program.MainForm.AddLog("Pdf created");
                        break;
                    case "all":
                        Program.MainForm.AddLog("Preparing file PDF...");
                        sFilePdf = sFolder + "\\Pikling.pdf";
                        ...
                        Program.MainForm.AddLog("Preparing file DOC...");
                        if (!doccre.CreateDocFile(sDataSource, sDataDest, sFileDoc))
                        {
                            sFileDoc = "";
                            Program.MainForm.AddLog("Doc Creator failed");
                        }
                        break;

                    case "txt":
                        sFileTxt = sFolder + "\\Pikling.txt";
                        Program.MainForm.AddLog("Preparing file TXT...");
                        if (!doccre.CreateTxtFile(sDataSource, sDataDest, sFileTxt))
                        {
                            sFileTxt = "";
                            Program.MainForm.AddLog("Txt Creator failed");
                        }
                        break;
                    case "doc":
                        sFilePdf = sFolder + "\\Pikling.doc";
                ...
                Program.MainForm.AddLog("Sending EMAIL...");
                Application.DoEvents();
                if (!doccre.SendEmailTo(sToAddr, sFileJpg, sFileDoc, sFilePdf, sFileTxt))
                    Program.MainForm.AddLog("Send email failed");
                else
                {
                    ...
                    tr1.Close();
                    bret = true;
                    Program.MainForm.AddLog("EMAIL SENT CORRECTLY");
                }
            }
            catch (Exception ex)
            {
                Program.MainForm.AddLog(String.Format("SendEmail Exception :{0}", ex.Message));
            }
            return bret;
        }
        ...
        public void SetImg1(Image img, String sFolder)
        {
            try
            {
                ...
                {   pictureBox1.Image = img;
                    ...
                    AddLog("WIDHT:" + img.Width.ToString() + " HEIGHT:" + img.Height.ToString());
                }
                else
                {
            ...
            {
                AddLog("Exception SetImg1:" + ex.Message);
            }
        }
        ...
        public void SetImg2(Image img, String sFolder)
        {
            ...
            {
                AddLog("Exception SetImg2:" + ex.Message);
            }
        }
        ...
        public void SetImg3(Image img, String sFolder)
        {
            ...
            {
                AddLog("Exception SetImg3:" + ex.Message);
            }
        }
        ...
        public void SetImg4(Image img, String sFolder)
        {
            ...
            {
                AddLog("Exception SetImg4:" + ex.Message);
            }
        }
        ...
        public void SetImg5(Image img, String sFolder)
        {
            ...
            {
                AddLog("Exception SetImg5:" + ex.Message);
            }
        }
        ...
        public void NewImage(String sImage, String sFolder)
        {
            ...
            {
                AddLog("Exception NewImage:" + ex.Message);
            }
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            _sockServer = new TCPServer(ip, 8081);
